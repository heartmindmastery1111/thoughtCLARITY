  ...
  if (screen === "intro") {
    return (
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.card}>
          <Text style={styles.eyebrow}>THE RETURN: RECLAIM PEACE</Text>
          <Text style={styles.title}>Clarity Session</Text>
          <Text style={styles.subtitle}>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>Exhale slowly through the mouth.</Text>
            <Text style={styles.infoSpacer}> </Text>
            <Text style={styles.infoText}>
              A longer exhale can help your nervous system settle.
            </Text>
            <Text style={styles.infoSpacer}> </Text>
            <Text style={styles.infoText}>
              Try 4 seconds in and 6 seconds out.
            </Text>
          </View>
